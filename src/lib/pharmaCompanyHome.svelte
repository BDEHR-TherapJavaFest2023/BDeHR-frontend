                    ...
                    <div class="stat">
                        ...
                        <div class="stat-desc">
                            {#if changenumberOfTimesPrescribed > 0}
                                {changenumberOfTimesPrescribed.toFixed(1)}% more
                                prescribed last month
                            {:else if changenumberOfTimesPrescribed < 0}
                                {(-1 * changenumberOfTimesPrescribed).toFixed(
                                    1
                                )}% less prescribed last month
                            {/if}
                        </div>
                    </div>
                    ...
                    <div class="stat">
                        ...
                        <div class="stat-desc">
                            {#if changetotalDemand > 0}
                                {changetotalDemand.toFixed(1)}% more demand than
                                last month
                            {:else if changetotalDemand < 0}
                                {(-1 * changetotalDemand).toFixed(1)}% less
                                demand than last month
                            {/if}
                        </div>
                    </div>
                    ...
                    <div class="stat">
                        ...
                        <div class="stat-desc">
                            {#if changetotalSale > 0}
                                {changetotalSale.toFixed(1)}% more sale than
                                last month
                            {:else if changetotalSale < 0}
                                {(-1 * changetotalSale).toFixed(1)}% less sale
                                than last month
                            {/if}
                        </div>
                    </div>
                    ...
                    <div class="stat">
                        ...
                        <div class="stat-desc">
                            {#if changegrowthPercentage > 0}
                                {changegrowthPercentage.toFixed(1)}% more growth
                                than last month
                            {:else if changegrowthPercentage < 0}
                                {(-1 * changegrowthPercentage).toFixed(1)}% less
                                growth than last month
                            {/if}
                        </div>
                    </div>
                </div>
